...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p class="style1">
        unit_shortname&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox3" runat="server" CssClass="style2" Width="217px"></asp:TextBox>
    </p>
    <p class="style1">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button7" runat="server" Height="35px" 
            onclick="Button7_Click" style="font-weight: 700; font-size: medium" Text="Prev" 
            Width="81px" />
        &nbsp;&nbsp;
    </p>
</asp:Content>
